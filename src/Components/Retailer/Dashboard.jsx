...
import { faTasks, faTachometer, faEye, faPencil, faTrashCan, faPlus } from '@fortawesome/free-solid-svg-icons';
            ...
            <div class="container">
                <section class="section">
                    <nav class="breadcrumb" aria-label="breadcrumbs">
                        <ul>
                            <li class="is-active"><Link to="/submissions" aria-current="page"><FontAwesomeIcon className="fas" icon={faTasks} />&nbsp;Submissions</Link></li>
                        </ul>
                    </nav>
                    <nav class="box">
                        <div class={`modal ${selectedSubmissionForDeletion ? 'is-active' : ''}`}>
                            ...
                            <div class="modal-card">
                                ...
                                <section class="modal-card-body">
                                    You are about to delete this submission and all the data inside of it. This action is cannot be undone. Are you sure you would like to continue?
                                </section>
                        ...
                        <div class="columns">
                            <div class="column">
                                <h1 class="title is-1"><FontAwesomeIcon className="fas" icon={faTasks} />&nbsp;Submission</h1>
                            </div>
                                        ...
                                        <tbody>
                                            ...
                                            {submissions && submissions.results && submissions.results.map(function(submission, i){
                                                return <tr>
                                                    ...
                                                    <td data-label="Created">{submission.createdTime}</td>
