                    ...
                    <nav class="box">
                        ...
                        <div class="columns pt-5">
                            <div class="column is-half">
                                <Link to={`/dashboard`} class="button is-medium is-hidden-touch"><FontAwesomeIcon className="fas" icon={faArrowLeft} />&nbsp;Back</Link>
                                <Link to={`/dashboard`} class="button is-medium is-fullwidth is-hidden-desktop"><FontAwesomeIcon className="fas" icon={faArrowLeft} />&nbsp;Back</Link>
                            </div>
