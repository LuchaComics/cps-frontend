...
import { faTasks, faBook, faTachometer, faPlus, faDownload, faArrowLeft, faCheckCircle, faCheck, faGauge, faUsers, faEye } from '@fortawesome/free-solid-svg-icons'
        ...
        <>
            <div class="container">
                <section class="section">
                    ...
                    <nav class="box">
                        <p class="title is-4"><FontAwesomeIcon className="fas" icon={faPlus} />&nbsp;New Comic Submission (Confirmation)</p>
                                    ...
                                    <div class="columns pt-5">
                                        ...
                                        {customerName === null
                                            ...
                                            <div class="column is-half has-text-right">
                                                <Link to={`/submissions/comics`} class="button is-medium is-primary is-hidden-touch"><FontAwesomeIcon className="fas" icon={faArrowLeft} />&nbsp;Back to List</Link>
                                                <Link to={`/submissions/comics`} class="button is-medium is-primary is-fullwidth is-hidden-desktop"><FontAwesomeIcon className="fas" icon={faArrowLeft} />&nbsp;Back to List</Link>
                                            </div>
                                            :
                                            <div class="column is-half has-text-right">
                                                <Link to={`/customer/${customerID}/comics`} class="button is-medium is-primary is-hidden-touch"><FontAwesomeIcon className="fas" icon={faArrowLeft} />&nbsp;Back to Customer</Link>
                                                <Link to={`/customer/${customerID}/comics`} class="button is-medium is-primary is-fullwidth is-hidden-desktop"><FontAwesomeIcon className="fas" icon={faArrowLeft} />&nbsp;Back to Customer</Link>
                                            </div>
                                        }
                                    </div>
                                </div>
