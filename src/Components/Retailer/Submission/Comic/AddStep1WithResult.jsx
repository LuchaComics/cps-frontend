...
import { faTasks, faBook, faTachometer, faPlus, faDownload, faArrowLeft, faTable, faCheckCircle, faCheck, faGauge, faUsers, faArrowUpRightFromSquare, faArrowRight } from '@fortawesome/free-solid-svg-icons'
