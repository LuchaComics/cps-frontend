            ...
            <div class="container">
                <section class="section">
                    ...
                    <nav class="box">
                        ...
                        <p class="pb-4">To begin, please select a customer that belongs to this customer. If you don't have a customer at this time, click <a href="/">here to skip pick a customer&nbsp;<FontAwesomeIcon className="fas" icon={faArrowRight} /></a> or
